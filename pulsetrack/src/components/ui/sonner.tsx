  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast:
            "group toast group-[.toaster]:bg-white group-[.toaster]:text-neutral-950 dark:group-[.toaster]:bg-neutral-950 dark:group-[.toaster]:text-neutral-50 group-[.toaster]:border-neutral-200 dark:group-[.toaster]:border-neutral-800",
